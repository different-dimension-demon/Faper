...
from lpce.spiking_t_sru import *
from lpce.trainer import *
from lpce import utils
from lpce.transformer import TRANS
...
if __name__ == '__main__':
    ...
    if mode == 'Train':
        model = TRANS(cuda_use, feature_dim, embed_dim, mem_dim, output_dim, dropout)
    ...
    if mode == 'Test':
        model = SRU(cuda_use, feature_dim, embed_dim, mem_dim, output_dim, 0)
